...
<div class="thrv_wrapper tve-tqb-page-type tqb-result-template-2 tve_editor_main_content tve_no_drag tve_clearfix" style="<?php echo $main_content_style; ?>">
	...
	<div class="thrv_wrapper thrv_contentbox_shortcode tve_tqb_content_box_light" data-tve-style="5">
		<div class="tve_cb tve_cb5">
			<div class="tve_cb_cnt">
				<h3>GET YOUR DETAILED RESULTS</h3>
				<p class="tqb-form-subtitle">To get more detailed results use the form below:</p>
