...
(function (modules) {
	...
	"workspace": {
		"editor": {
			"js": {
				"froala": {
					"froala_editor.js": function (exports, module, require) {
						/*!
						...
						(function ( $ ) {
							...
							$.FE.MODULES.markers = function ( editor ) {
								...
								function insert() {
									...
									try {
										...
										if ( containter != editor.el && editor.$el.find( containter ).length === 0 ) {
											return null;
										}
									...
									try {
										if ( sel.rangeCount ) {
											...
											if ( node.nodeType == Node.ELEMENT_NODE ) {
												...
												if ( ! node_found && node.childNodes.length > 0 && $( node.childNodes[0] ).text().replace( /\u200B/g, '' ) === text().replace( /\u200B/g, '' ) && [
													                                                                                                                                                  'BR',
													                                                                                                                                                  'IMG',
													                                                                                                                                                  'HR'
												                                                                                                                                                  ].indexOf( node.childNodes[0].tagName ) < 0 ) {
									...
									try {
										if ( sel.rangeCount ) {
											...
											if ( node.nodeType == Node.ELEMENT_NODE ) {
												...
												if ( ! node_found && node.childNodes.length > 0 && $( node.childNodes[node.childNodes.length - 1] ).text() === text() && [
													                                                                                                                         'BR', 'IMG',
													                                                                                                                         'HR'
												                                                                                                                         ].indexOf( node.childNodes[node.childNodes.length - 1].tagName ) < 0 ) {
								...
								function blocks() {
									...
									if ( inEditor() && sel.rangeCount ) {
										...
										for ( i = 0; i < rngs.length; i ++ ) {
											...
											// Add the start node.
											if ( editor.node.isBlock( start_node ) && blks.indexOf( start_node ) < 0 ) {
									...
									for ( i = blks.length - 1; i > 0; i -- ) {
										...
										if ( $( blks[i] ).find( blks ).length && (blks[i].tagName != 'LI' || (blks[i].children.length == 1 && blks.indexOf( blks[i].children[0] ) >= 0)) ) {
											blks.splice( i, 1 );
										}
									}
							...
							$.FE.HTML5Map = {
								...
								$.FE.MODULES.clean = function ( editor ) {
									...
									function _node( node ) {
										...
										if ( node.nodeType == Node.ELEMENT_NODE ) {
											if ( node.getAttribute( 'data-fr-src' ) ) {
												node.setAttribute( 'data-fr-src', editor.helpers.sanitizeURL( node.getAttribute( 'data-fr-src' ) ) );
											}

											if ( node.getAttribute( 'href' ) ) {
												node.setAttribute( 'href', editor.helpers.sanitizeURL( node.getAttribute( 'href' ) ) );
											}
							...
							$.FE.MODULES.html = function ( editor ) {
								...
								function fillEmptyBlocks( around_markers ) {
									...
									for ( var i = 0; i < blocks.length; i ++ ) {
										...
										if ( block.getAttribute( 'contenteditable' ) !== 'false' &&
											...
											if ( block.tagName != 'TABLE' && block.tagName != 'TBODY' && block.tagName != 'TR' ) {
								...
								function _brsAroundSelection() {
									...
									if ( p_node ) {
										...
										// Push current node, prev and next one.
										if ( p_node && els.indexOf( p_node ) < 0 ) {
											els.push( p_node );
										}
							...
							$.FE.MODULES.edit = function ( editor ) {
								...
								function on() {
									if ( editor.$wp ) {
										...
										if ( editor.$tb ) {
											editor.$tb.removeClass( 'fr-disabled' ).attr( 'aria-disabled', false );
										}
										disableDesign();
									}
							...
							$.FE.MODULES.cursorLists = function ( editor ) {
								...
								function _endEnter( marker ) {
									var li = _firstParentLI( marker );
									if ( editor.opts.htmlUntouched && editor.node.isEmpty( li ) ) {
										return _startEnter( marker );
									}
							...
							$.FE.MODULES.keys = function ( editor ) {
								...
								function _mapKeyUp( e ) {
									...
									if ( e && (e.which == $.FE.KEYCODE.ENTER || e.which == $.FE.KEYCODE.BACKSPACE || (e.which >= 37 && e.which <= 40 && ! editor.browser.msie)) ) {
										if ( ! (e.which == $.FE.KEYCODE.BACKSPACE && regular_backspace) ) {
											_positionCaret();
										}
									}
								...
								function _typingKeyDown( e ) {
									...
									if ( ctrlKey( e ) || (keycode >= 37 && keycode <= 40) || (! isCharacter( keycode ) && keycode != $.FE.KEYCODE.DELETE && keycode != $.FE.KEYCODE.BACKSPACE && keycode != $.FE.KEYCODE.ENTER && keycode != 229) ) {
										return true;
									}
							...
							$.FE.MODULES.format = function ( editor ) {
								 ...
								 */
								function is( tag, attrs, return_node ) {
									if ( typeof attrs == 'undefined' ) {
										attrs = {};
									}
									...
									if ( f_child && f_child.nodeType == Node.ELEMENT_NODE && _matches( f_child, _query( tag, attrs ) ) ) {
										return ( return_node ? f_child : true );
									}
									...
									if ( p_node && p_node.nodeType == Node.ELEMENT_NODE && p_node !== editor.el && _matches( p_node, _query( tag, attrs ) ) ) {
										return ( return_node ? p_node : true );
									}
							...
							$.FE.MODULES.data = function ( a ) {
								...
								function i() {
									...
									for ( var d = 0; d < c.length; d ++ ) {
										var e = n( c[d] ) || "";
										if ( ! (e !== n( b( n( "mcVRDoB1BGILD7YFe1BTXBA7B6==" ) ) ) && e.indexOf( m, e.length - m.length ) < 0 && [
											                                                                                                          n( "9qqG-7amjlwq==" ), n( "KA3B3C2A6D1D5H5H1A3==" ),
											                                                                                                          n( "QzbzvxyB2yA-9m==" ), n( "ji1kacwmgG5bc==" ),
								...
								var j, k, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", m = function () {
									for (
										var a = 0, b = document.domain, c = b.split( "." ), d = "_gd" + (new Date).getTime(); a < c.length - 1 && document.cookie.indexOf( d + "=" + d ) == - 1;
									) {
									...
									if ( typeof snapshot == 'undefined' ) {
										...
										if ( ! editor.undo_stack[editor.undo_index - 1] || ! editor.snapshot.equal( editor.undo_stack[editor.undo_index - 1], snapshot ) ) {
											...
											if ( snapshot.html != last_html ) {
												...
												editor.events.trigger( 'undo.saveStep' );
											}
										}
									}
									else {
								...
								function _topNormalized( $el, top, obj_height ) {
									...
									if ( ! editor.helpers.isMobile() && editor.$tb && $el.parent().get( 0 ) != editor.$tb.get( 0 ) ) {
										...
										if ( $el.parent().get( 0 ) == editor.$sc.get( 0 ) ) {
											p_offset = p_offset - $el.parent().position().top;
										}
							...
							require( './plugins/paragraph_format' )( $ );
					...
					"plugins": {
						"align.js": function (exports, module, require) {
						...
						"link.js": function (exports, module, require) {
							/**
							 * Custom link extension based on the default froala link implementation
							 *
							 */
							module.exports = function ( $ ) {
								var has_text = false,
									skip_change = false,
									autocomplete_item = false;

								function action_label( action ) {
									var action_names = {
										'thrive_lightbox': 'TCB Lightbox',
										'thrive_leads_2_step': 'ThriveBox'
									};

									return action_names[action] ? action_names[action] : action;
								}
								...
								function autocomplete( $input, select ) {
									...
									$input.autocomplete( {
										...
										source: function ( request, response ) {
											...
											/**
											 * if text starts with http, no search
											 */
											if ( /^https?:/.test( request.term ) || request.term.indexOf( '.' ) !== - 1 ) {
												return response();
											}

											TVE.ajax( 'post_search', 'post', {q: request.term, search_lightbox: true} )
												.done( function ( data ) {
													cache = data;
													response( data );
												} );
									...
									$input.autocomplete( 'widget' ).addClass( 'tcb-link-suggest' );
								}

								$.extend( $.FE.POPUP_TEMPLATES, {
									'tcbLink.edit': '[_BUTTONS_]',
									'tcbLink.insert': '[_BUTTONS_][_INPUT_LAYER_]'
								} );
								$.extend( $.FE.DEFAULTS, {
									linkEditButtons: ['linkOpen', 'linkEdit', 'linkRemove'],
									linkInsertButtons: ['linkBack', 'searchSettings'],
									linkAttributes: {},
									linkAutoPrefix: "http://",
									linkText: ! 0
								} );
								...
								$.FE.PLUGINS.link = function ( editor ) {
									function get() {
										if ( editor.$wp ) {
											...
											if ( c_el && (c_el.contains && c_el.contains( editor.el ) || ! editor.el.contains( c_el ) || editor.el === c_el) ) {
												c_el = null;
											}

											if ( c_el && c_el.tagName === 'A' ) {
												return c_el;
											}
											var s_el = editor.selection.element();
											var e_el = editor.selection.endElement();
											...
											if ( e_el && (e_el.contains && e_el.contains( editor.el ) || ! editor.el.contains( e_el ) || editor.el === e_el) ) {
												e_el = null;
											}

											if ( s_el && (s_el.contains && s_el.contains( editor.el ) || ! editor.el.contains( s_el ) || editor.el === s_el) ) {
												s_el = null;
											}
									...
									function _showEditPopup( link ) {
										var $popup = editor.popups.get( 'tcbLink.edit' );
										...
										if ( ! editor.popups.isVisible( 'tcbLink.edit' ) ) {
											editor.popups.refresh( 'tcbLink.edit' );
										}
										editor.popups.setContainer( 'tcbLink.edit', editor.$sc );
										var left = $link.offset().left + $( link ).outerWidth() / 2;
										var top = $link.offset().top + $link.outerHeight();
										editor.popups.show( 'tcbLink.edit', left, top, $link.outerHeight() );
									}

									function _hideEditPopup() {
										editor.popups.hide( 'tcbLink.edit' );
									}
									...
									function _initEditPopup() {
										...
										var $popup = editor.popups.create( 'tcbLink.edit', template );

										if ( editor.$wp ) {
											editor.events.$on( editor.$wp, 'scroll.link-edit', function () {
												if ( get() && editor.popups.isVisible( 'tcbLink.edit' ) ) {
													_showEditPopup( get() );
												}
											} );
										}
									...
									function _refreshInsertPopup() {
										var $popup = editor.popups.get( 'tcbLink.insert' );
										var link = get();
										autocomplete_item = false;
										if ( link ) {
											var $link = $( link ),
											...
											if ( link.classList.contains( 'tve_evt_manager_listen' ) ) {
												evt = TVE.EventManager.get( link, 'click' );
												if ( evt ) {
													autocomplete_item = {
														is_popup: true,
														title: action_label( evt.a ),
														event_action: evt.a,
														id: evt.config.l_id || evt.config.id
													};
													_href = '#' + autocomplete_item.title;
												}
											}

											text_inputs.each( function () {
												var attr = this.getAttribute( 'name' );
												this.value = attr === 'href' && autocomplete_item ? _href : link.getAttribute( attr || '' );
											} );

											check_inputs.prop( 'checked', false ).each( function () {
												var linkAttr = link.getAttribute( this.getAttribute( 'name' ) );
												this.checked = linkAttr && linkAttr.indexOf( this.getAttribute( 'data-checked' ) ) !== - 1;
											} );
										...
										has_text = $popup.find( 'input[name="text"]' ).val().length;
										skip_change = true;
									...
									function _showInsertPopup() {
										var $btn = editor.$tb.find( '.fr-command[data-cmd="tcbLink"]' );
										var $popup = editor.popups.get( 'tcbLink.insert' );
										...
										if ( ! $popup.hasClass( 'fr-active' ) ) {
											editor.popups.refresh( 'tcbLink.insert' );
											editor.popups.setContainer( 'tcbLink.insert', editor.$tb || editor.$sc );

											if ( $btn.is( ':visible' ) ) {
												var left = $btn.offset().left + $btn.outerWidth() / 2;
												var top = $btn.offset().top + (editor.opts.toolbarBottom ? 10 : $btn.outerHeight() - 10);
												editor.popups.show( 'tcbLink.insert', left, top, $btn.outerHeight() );
											}
											else {
												editor.position.forSelection( $popup );
												editor.popups.show( 'tcbLink.insert' );
											}
										}
									}
									...
									function _initInsertPopup( delayed ) {
										if ( delayed ) {
											editor.popups.onRefresh( 'tcbLink.insert', _refreshInsertPopup );
											editor.popups.onHide( 'tcbLink.insert', _hideInsertPopup );
										...
										input_layer += '<div class="fr-checkbox-line">' +
										               '<span class="fr-checkbox"><input name="target" class="fr-link-attr" data-checked="_blank" type="checkbox" id="fr-link-target-' + editor.id + '" tabIndex="' + (++ tab_idx) + '"><span>' + checkmark + '</span></span><label for="fr-link-target-' + editor.id + '">' + editor.language.translate( 'Open in new tab' ) + '</label>' +
										               '&nbsp;<span class="fr-checkbox"><input name="rel" class="fr-link-attr" data-checked="nofollow" type="checkbox" id="fr-link-rel-' + editor.id + '" tabIndex="' + (++ tab_idx) + '"><span>' + checkmark + '</span></span><label for="fr-link-rel-' + editor.id + '">' + editor.language.translate( 'Nofollow' ) + '</label>' +
										               '</div>';
										...
										// Set the template in the popup.
										var $popup = editor.popups.create( 'tcbLink.insert', template ),
											$url = $popup.find( '#fr-link-insert-layer-url-' + editor.id ),
											$text = $popup.find( '#fr-link-insert-layer-text-' + editor.id );
										...
										autocomplete( $url, function ( item ) {
											if ( ! has_text ) {
												$text.val( item.title );
											}
										...
										if ( editor.$wp ) {
											editor.events.$on( editor.$wp, 'scroll.link-insert', function () {
												...
												if ( $current_image && editor.popups.isVisible( 'tcbLink.insert' ) ) {

												}

												if ( get && editor.popups.isVisible( 'tcbLink.insert' ) ) {
													update();
												}
											} );
										}
									...
									function insert( href, text, attrs ) {
										...
										if ( ! $current_image && editor.el.tagName != 'A' ) {
											editor.selection.restore();
											editor.popups.hide( 'tcbLink.insert' );
										}
										else if ( editor.el.tagName == 'A' ) {
											editor.$el.focus();
										}
										...
										if ( autocomplete_item && autocomplete_item.is_popup ) {
										...
										if ( link ) {
											...
											$link.attr( attrs );
											if ( autocomplete_item && autocomplete_item.is_popup ) {
												TVE.EventManager.replace( link, 'click', {
													a: autocomplete_item.event_action, config: {
														l_id: autocomplete_item.id,
														id: autocomplete_item.id
													}
												} );
											} else {
												TVE.EventManager.remove( link, 'click' );
											}
											...
											for ( var i = 0; i < links.length; i ++ ) {
												/**
												 * Set this up as an event manager
												 */
												if ( autocomplete_item && autocomplete_item.is_popup ) {
													TVE.EventManager.replace( links[i], 'click', {
														a: autocomplete_item.event_action, config: {
															l_id: autocomplete_item.id,
															id: autocomplete_item.id
														}
													...
													TVE.EventManager.remove( links[i], 'click' );
												}
												$link = $( links[i] );
												$link.attr( attrs );
										...
										if ( ! $current_image ) {
											...
											var $pop = editor.popups.get( 'tcbLink.insert' );
									...
									function update() {
										...
										if ( link ) {
											...
											if ( ! editor.popups.isVisible( 'tcbLink.insert' ) ) {
												editor.popups.refresh( 'tcbLink.insert' );
												editor.selection.save();
											...
											editor.popups.setContainer( 'tcbLink.insert', editor.$sc );
											...
											editor.popups.show( 'tcbLink.insert', left, top, $ref.outerHeight() );
										}
									}
								...
								$.FE.DefineIcon( 'tcbLink', {NAME: 'link'} );
								$.FE.RegisterShortcut( $.FE.KEYCODE.K, 'tcbLink', null, 'K' );
								$.FE.RegisterCommand( 'tcbLink', {
									title: 'Insert Link',
									undo: false,
									focus: true,
									...
									popup: true,
									callback: function () {
										if ( ! this.popups.isVisible( 'tcbLink.insert' ) ) {
											...
											this.popups.hide( 'tcbLink.insert' );
										}
									},
									plugin: 'link'
								} )
								...
								$.FE.DefineIcon( 'searchSettings', {
									NAME: 'cog'
								} );
								$.FE.RegisterCommand( 'searchSettings', {
									...
									refreshAfterCallback: false,
									callback: function () {
										TVE.modal_open( 'options-post-types' );
									}
								} );
							};
						},
						"lists.js": function (exports, module, require) {
							module.exports = function ($) {
						...
						"paragraph_format.js": function (exports, module, require) {
							module.exports = function ($) {
...
})("workspace/editor/js/froala/froala_editor");
