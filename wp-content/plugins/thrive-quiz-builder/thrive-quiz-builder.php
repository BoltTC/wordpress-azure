...
if ( ! class_exists( 'Thrive_Quiz_Builder' ) ) :
	...
	final class Thrive_Quiz_Builder {
		 ...
		 */
		const REQUIRED_TCB_VERSION = '1.500.20';
		...
		function filter_subscribe_data( $data, $connection ) {
			...
			} else if ( $connection instanceof Thrive_Dash_List_Connection_AWeber ) {
				$data['aweber_tags'] .= ', ' . implode( ', ', $tags );

			} else if ( $connection instanceof Thrive_Dash_List_Connection_Infusionsoft ) {
