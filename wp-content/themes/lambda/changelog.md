...
- Fixed breadcrumbs for month archive link
...
- Updated Revolution Slider Version 5.3

# Version 1.41.0
> Release Date : 14th November 2016

- Updated Visual Composer Version 5.0
- Changed stack code to load stack CSS using wp_enqueue_style (allows override in child theme)
- New Demo: Consultant Business

# Version 1.42.0
> Release Date : 22nd November 2016

- Removed TGM plugin nag message.
...
- Updated Visual Composer to v5.0.1
- New Demo: Aquarium
...
- Fix woocommerce checkout with stripe gateway plugin.
- Updated Woocommerce to v2.6.9
...
- Added Visual Composer Button Shortcode (used in grid builder)
- Fixed minor issue in PHP 7 with column calculations
- Updated documentation

# Version 1.47.0
> Release Date : 23rd January 2017

- Better coverage of translation functions in pot files
...
- Fixed wrong Indentation on multiple dropdown menus on mobile
- New Demo ~ Gamer Blog

# Version 1.50.0
> Release Date : 14th March 2017

- Updated Font Awesome icons to v4.7
...
- Updated WooCommerce templates to be compatible with WooCommerce 3.0.3
...
- Fix for product categories and tags options
- Updated Revolution Slider plugin to v5.4.3.1
- Fixed bug for 404 page when custom permalinks are set.
- Woocommerce sitewide store message is now dismissible.
- Compatible with Woocommerce 3.0.7
- New Demo ~ Elearning
...
- Cart widget on menu now takes you to the Cart page when clicked, if menu is set to work on hover.
- Woocommerce translations fixed.
- Fixed sticky menu offset on mobiles.
- Updated Google Maps API to the latest release version.
