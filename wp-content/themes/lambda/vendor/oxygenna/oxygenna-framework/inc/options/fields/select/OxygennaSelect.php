        ...
        switch ($database) {
            case 'custom_post_type':
                if ($this->_field['post_type'] === 'oxy_service') {
                    $this->_field['blank'] = __('Select a Service post', 'lambda-admin-td');
                }
            case 'custom_post_id':
            ...
            case 'taxonomy':
                ...
                break;
            case 'revolution':
                $this->_field['blank'] = __('Select a Slideshow', 'lambda-admin-td');
                global $wpdb;
            ...
            case 'layerslider':
                if (class_exists('LS_Sliders')) {
                    ...
                    $this->_field['blank'] = __('Please activate LayersSlider plugin', 'lambda-admin-td');
                }
                break;
            case 'slideshow':
                $this->_field['blank'] = __('Select a Slideshow', 'lambda-admin-td');
            ...
            case 'staff_featured':
                $this->_field['blank'] = __('Select a Staff member', 'lambda-admin-td');
            ...
            case 'icons':
                ...
                break;
            case 'categories':
                //$this->_field['blank'] = __('all categories', 'lambda-admin-td');
                $data = get_categories(array('orderby' => 'name', 'hide_empty' => '0'));
                break;
            case 'portfolios':
                $this->_field['blank'] = __('Select a Portfolio', 'lambda-admin-td');
            ...
            case 'typekit_kits':
                ...
                if (isset($theme_options['unregistered']['typekit_kits'])) {
                    ...
                    if (!empty($kits_details)) {
                        $this->_field['blank'] = __('Select a kit', 'lambda-admin-td');
